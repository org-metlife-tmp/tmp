 ...
 *
 */
public class RecvCounterPosTransCheckController extends CFMBaseController {

    private final static Log logger = LogbackLog.getLog(RecvCounterPosTransCheckController.class);
    private RecvCounterPosTransCheckService service = new RecvCounterPosTransCheckService();

    /**
     * 结算对账_单据列表 
     */
	@Auth(hasForces = {"RECVCOUNTERPOSDETAILCHECK"})
    public void list() {
