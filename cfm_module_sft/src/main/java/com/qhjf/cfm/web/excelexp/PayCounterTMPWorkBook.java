 ...
 * @Description:
 */
public class PayCounterTMPWorkBook extends AbstractWorkBook {

	public PayCounterTMPWorkBook() {
    ...
    public Workbook getWorkbook() {
    			...
    			List<Record> list = Db.find(sqlPara);
    			 ...
    			 this.fileName = "TMP" + "_Ebankpayment_" +DateKit.toStr(new Date(), "YYYYMMdd")+".xls";
