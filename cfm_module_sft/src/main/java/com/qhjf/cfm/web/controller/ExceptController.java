 ...
 * @date 2019年01月21日
 */
public class ExceptController extends CFMBaseController {

    private final static Log logger = LogbackLog.getLog(ExceptController.class);
    private ExceptService service = new ExceptService();
    ...
    private SqlPara getSqlPara(Long[] inst_id, Long[] exclude_inst_id, Record rec) {
        ...
        return Db.getSqlPara("except.findExceptlistPendingList", Kv.by("map", kv));
    }
