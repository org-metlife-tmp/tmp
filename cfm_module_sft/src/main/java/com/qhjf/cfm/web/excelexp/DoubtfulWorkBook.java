 ...
 * @Description: 可疑数据导出
 */
public class DoubtfulWorkBook extends AbstractWorkBook {

    public DoubtfulWorkBook() {
        this.optype = "sftdoubtful_listexport";
        this.titleNames = new String[]{
                "pay_date", "pay_code", "pay_mode", "bank_key", "bankkey_desc",
