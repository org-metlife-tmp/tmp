...
import com.qhjf.cfm.web.service.HeadOrgNcCheckService;

import java.util.List;

public class HeadOrgNcCheckController extends CFMBaseController {

	private static final Log log = LogbackLog.getLog(HeadOrgNcCheckController.class);


    private HeadOrgNcCheckService service = new HeadOrgNcCheckService();
