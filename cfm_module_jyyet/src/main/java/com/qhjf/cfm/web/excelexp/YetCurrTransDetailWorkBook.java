...
public class YetCurrTransDetailWorkBook extends AbstractWorkBook {

    public YetCurrTransDetailWorkBook() {
        this.optype = "yet_currtransexport";
        this.fileName = "当日余额明细.xls";
