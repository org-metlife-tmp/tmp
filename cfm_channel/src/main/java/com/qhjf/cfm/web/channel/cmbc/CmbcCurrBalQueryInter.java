...
public class CmbcCurrBalQueryInter implements ISingleResultChannelInter{
	...
	public Record parseResult(String jsonStr)throws Exception {
		...
		if("0".equals(resultCode)){
			...
			record.set("bal", detailJson.get("AVLBLV"));
			record.set("available_bal", detailJson.get("AVLBLV"));
			record.set("frz_amt", detailJson.get("HLDBLV"));
			return record;
		}else{
