 ...
 *
 */
public class CmbcBatchRecvStatusQueryInter  implements IMoreResultChannelInter {
	private static Logger log = LoggerFactory.getLogger(CmbcBatchRecvStatusQueryInter.class);
