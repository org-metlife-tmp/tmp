 ...
 */
public class CmbcTradeResultBatchRecvQueryInter implements IMoreResultChannelInter {
	private static final Logger log = LoggerFactory.getLogger(CmbcTradeResultBatchRecvQueryInter.class);
