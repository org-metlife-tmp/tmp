...
public class AutoBindRoutesPlugins extends Routes {
    ...
    public AutoBindRoutesPlugins autoScan(boolean autoScan) {
        this.autoScan = autoScan;
        return this;
    }

    @SuppressWarnings("unchecked")
    public AutoBindRoutesPlugins addExcludeClasses(Class<? extends Controller>... clazzes) {
        if (clazzes != null) {
    ...
    public AutoBindRoutesPlugins addExcludeClasses(List<Class<? extends Controller>> clazzes) {
        excludeClasses.addAll(clazzes);
        return this;
    }

    public AutoBindRoutesPlugins addJars(String... jars) {
        if (jars != null) {
            for (String jar : jars) {
                includeJars.add(jar);
            }
    ...
    public AutoBindRoutesPlugins includeAllJarsInLib(boolean includeAllJarsInLib) {
        this.includeAllJarsInLib = includeAllJarsInLib;
        return this;
    }

    public AutoBindRoutesPlugins suffix(String suffix) {
        this.suffix = suffix;
        return this;
    }
