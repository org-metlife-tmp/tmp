...
public class OAReciveDataResp extends ParentResp{
	...
	public OAReciveDataResp(JSONObject json,int handle_status){
	...
	public OAReciveDataResp(JSONObject json,int handle_status,String handle_err_code,String handle_err_message){
		this.flow_id = json==null?null:json.getString("flow_id");
		this.send_count = json==null?-1:json.getInteger("send_count");
		this.handle_status = handle_status;
