...
import com.qhjf.cfm.web.service.SktTradService;
...
public class SktTradController extends CFMBaseController {

    private final static Log logger = LogbackLog.getLog(SktTradController.class);
    private SktTradService service = new SktTradService();


    /**
     * 未核对单据查询
     */
    @Auth(hasForces = {"SKTCheck"})
