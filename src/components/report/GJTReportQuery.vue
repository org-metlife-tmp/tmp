    ...
    <el-container id="aisleSet">
        ...
        <el-main>
            <el-table :data="tableList"
                ...
                <el-table-column prop="recv_account_no" label="归集主账号" :show-overflow-tooltip="true" ></el-table-column>
                <el-table-column prop="collect_amount" label="归集金额" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="collect_status" label="状态" :show-overflow-tooltip="true" :formatter="transitStatus"></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            transitStatus: function (row, column, cellValue, index) {
                return this.colStatusList[cellValue];
            },
            //导出
            exportFun:function () {
