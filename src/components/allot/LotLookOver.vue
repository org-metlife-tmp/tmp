    ...
    <div id="lotLookOver">
        ...
        <section class="table-content">
            <el-table :data="tableList"
                      border size="mini">
                <el-table-column prop="pay_account_bank" label="批次号" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="recv_account_no" label="总笔数" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="recv_account_name" label="总金额" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="payment_amount" label="成功笔数" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="payment_amount" label="成功金额" :show-overflow-tooltip="true"></el-table-column>
...
<script>
    ...
    export default {
        name: "LotLookOver",
        created: function () {
            this.$emit("transmitTitle", "批量调拨-查看");
