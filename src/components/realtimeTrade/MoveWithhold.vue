            ...
            <el-dialog title="详情"
                ...
                <el-form :model="dialogData" size="mini">
                    <el-row>
                        ...
                        <el-col :span="businessLength[index]" v-for="(payItem,index) in payMessage"
                                :key="payItem.title">
                        ...
                        <el-col :span="payLength[index]" v-for="(business,index) in businessMessage"
                                :key="business.title">
                            <el-form-item :label-width="formLabelWidth">
