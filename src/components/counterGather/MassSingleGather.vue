            ...
            <el-dialog :visible.sync="dialogVisible"
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                            <el-form-item label="客户号">
                                <el-input v-model="dialogData.consumer_no" disabled></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="客户名称">
                                <el-input v-model="dialogData.consumer_acc_name" disabled></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                        ...
                        <el-col :span="12">
                            <el-form-item label="投保单号">
                                <el-input v-model="dialogData.preinsure_bill_no" disabled></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="保单号">
                                <el-input v-model="dialogData.insure_bill_no" disabled></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                        ...
                        <el-col :span="12">
                            <el-form-item label="投保人">
                                <el-input v-model="dialogData.insure_name" disabled></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                ...
                <el-dialog :visible.sync="innerVisible"
                    ...
                    <span slot="footer" class="dialog-footer" style="text-align:center">
                        ...
                        <el-button type="warning" size="mini" @click="setVoucherData" :disabled="!currentVoucher">确 定</el-button>
                    </span>
                </el-dialog>
            </el-dialog>
        </el-footer>
    ...
    export default {
        ...
        methods: {
            ...
            transitStatus: function (row, column, cellValue, index) {
                ...
                return constants.SftRecvCounterPayStatus[cellValue];
            },
            //展示格式转换-来源系统
            ...
            lookCurrent: function (row) {
                ...
                this.$axios({
                    ...
                    method: "post",
                    data: {
                        optype: "recvgroupcounter_detail",
                        params: {
                            id: row.id
                        }
                    }
