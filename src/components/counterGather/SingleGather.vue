    ...
    <el-container id="singleGather">
            ...
            <div class="search-setion">
                <el-form :inline="true" :model="searchData" size="mini">
                    <el-row>
                        <el-col :span="4">
                            <el-form-item>
                                <el-select v-model="searchData.org_id" placeholder="请选择收款机构"
                        ...
                        <el-col :span="4">
                            <el-form-item>
                                <el-select v-model="searchData.interactive_mode" placeholder="请选择收款方式"
                                           clearable filterable
                                           style="width:100%">
                        ...
                        <el-col :span="4">
                            <el-form-item>
                                <el-select v-model="searchData.interactive_mode" placeholder="请选择票据状态"
                                           clearable filterable
                                           style="width:100%">
                                    <el-option v-for="(interact,key) in interactiveList"
                                               :key="key"
                        ...
                        <el-col :span="4">
                            <el-form-item>
                                <el-input v-model="searchData.master_batchno" clearable placeholder="请输入终端机编号"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="4">
                            <el-form-item>
                                <el-input v-model="searchData.master_batchno" clearable placeholder="请选择资金用途"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="4">
                            <el-form-item>
                                <el-select v-model="searchData.interactive_mode" placeholder="是否第三方缴费"
                                           clearable filterable
                                           style="width:100%">
                                    <el-option v-for="(interact,key) in interactiveList"
                                               :key="key"
        ...
        <el-main>
            <el-table :data="tableList"
                ...
                <el-table-column prop="interactive_mode" label="保单号" :show-overflow-tooltip="true"></el-table-column>
                ...
                <el-table-column prop="send_on" label="终端机编号" width="110px"
                ...
                <el-table-column prop="send_on" label="投保人证件号" width="120px"
                                 :show-overflow-tooltip="true"></el-table-column>
                ...
                <el-table-column prop="send_on" label="缴费人证件号" width="110px"
                                 :show-overflow-tooltip="true"></el-table-column>
