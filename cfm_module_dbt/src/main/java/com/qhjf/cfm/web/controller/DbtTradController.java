...
public class DbtTradController extends CFMBaseController {

    private final static Log logger = LogbackLog.getLog(DbtTradController.class);
    private DbtTradService service = new DbtTradService();
